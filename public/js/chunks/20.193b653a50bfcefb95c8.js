                        ...
                        data.item.status == 2
                          ? _c(
                              "b-dropdown-item",
                              {
                                on: {
                                  click: function ($event) {
                                    return _vm.payDebt(data.item.id)
                                  },
                                },
                              },
                              [
