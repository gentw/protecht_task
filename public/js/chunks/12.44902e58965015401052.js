...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    var emit = _ref.emit;
    var registerNewClient = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])(false);
    var blankSaleData = {
      client_id: '',
      new_client: '',
      sold_price: '',
    ...
    var saleData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])(JSON.parse(JSON.stringify(blankSaleData)));
    var clientsList = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])([]);
    var servicesList = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])([]);
    Object(vee_validate__WEBPACK_IMPORTED_MODULE_2__["extend"])('doublerequired', Object(_home_gex_development_bluesky_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
      validate: function validate(value) {
        var regex = /^([A-Z]){3}$/;
        return regex.test(value);
      },
      message: 'Cmimi i shkruar nuk lejohet (shembujt e lejuar: 50, 50.35)!'
    }, regex));
    var valutaValidator = function valutaValidator(valuta) {
      var regex = /^([A-Z]){3}$/;
      if (!regex.test(valuta)) {
        return 'Valuta nuk eshte valide!';
      }
      return true;
    };

    // add the custom validator to the validation rules object
    var rules = {
      required: function required(value) {
        return !!value || 'This field is required.';
      },
      valuta: valutaValidator
    };
    var resetSaleData = function resetSaleData() {
      saleData.value = JSON.parse(JSON.stringify(blankSaleData));
    };
    var onSubmit = function onSubmit() {
      var regexPattern = /^(\d+|\d+\.\d{1,2})$/;
      var mainCurrency = saleData.value.main_currency;
      ...
      _store__WEBPACK_IMPORTED_MODULE_8__["default"].dispatch('app-sale/addSale', saleData.value).then(function () {
        emit('refetch-data');
        emit('update:is-add-new-sale-sidebar-active', false);
      });
    };
    var _formValidation = Object(_core_comp_functions_forms_form_validation__WEBPACK_IMPORTED_MODULE_5__["default"])(resetSaleData),
    ...
    var searchClients = function searchClients(keyword) {
      ...
      setTimeout(function () {
        _store__WEBPACK_IMPORTED_MODULE_8__["default"].dispatch('app-sale/searchUserByName', keyword).then(function (response) {
          clientsList.value = response.data;
        });
      }, 500);
    };
    var fetchServicesInDropDownList = function fetchServicesInDropDownList() {
      _store__WEBPACK_IMPORTED_MODULE_8__["default"].dispatch('app-service/fetchAllServices').then(function (response) {
    ...
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["watch"])(saleData.value, function (newValue, oldValue) {
