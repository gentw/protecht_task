...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  actions: {
    ...
    deleteSale: function deleteSale(ctx, id) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("/api/deleteSale/".concat(id)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
...
function useUsersList() {
  ...
  var deleteSale = function deleteSale(id) {
    alert(1);
    _store__WEBPACK_IMPORTED_MODULE_1__["default"].dispatch('app-sale/deleteSale', id);
  };
