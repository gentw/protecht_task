...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var printInvoice = function printInvoice() {
      ...
      // Load the invoice page in an iframe inside the print window
      var invoiceFrame = printWindow.document.createElement('iframe');
      invoiceFrame.src = 'http://app.blueskytravel.com/sale_invoice/4/11';
      invoiceFrame.width = '100%';
      invoiceFrame.height = '100%';
      printWindow.document.body.appendChild(invoiceFrame);

      // Wait for the invoice page to fully load before printing
