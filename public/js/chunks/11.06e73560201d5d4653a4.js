...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/views/invoice/invoice-list/InvoiceList.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    InvoiceList: !(function webpackMissingModule() { var e = new Error("Cannot find module '@/views/invoice/invoice-list/InvoiceList.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
  },
  setup: function setup() {
