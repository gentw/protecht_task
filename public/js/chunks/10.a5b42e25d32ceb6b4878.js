...
function useUsersList() {
  ...
  // { key: 'service.service_name', sortable: true, label: 'Sherbimi' },
  // { key: 'sold_price', sortable: true, label: 'Cmimi shitjes' },
  // { key: 'profit', sortable: true, label: 'Fitimi' },
  // { key: 'purchased_price', sortable: true, label: 'Cmimi blerjes' },
  ...
  var sortBy = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__["ref"])('sales.id');
