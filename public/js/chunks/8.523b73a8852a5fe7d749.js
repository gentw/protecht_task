...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    // Register module
    if (!_store__WEBPACK_IMPORTED_MODULE_4__["default"].hasModule(SALE_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_4__["default"].registerModule(SALE_APP_STORE_MODULE_NAME, saleStoreModule);
    if (!_store__WEBPACK_IMPORTED_MODULE_4__["default"].hasModule(USER_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_4__["default"].registerModule(USER_APP_STORE_MODULE_NAME, userStoreModule);
    ...
    var generateReports = function generateReports() {
      _store__WEBPACK_IMPORTED_MODULE_4__["default"].dispatch('app-sale/fetchReportsByYearAndMonth', selectMonthYear).then(function (response) {
