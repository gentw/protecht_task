  ...
  Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__["watch"])([currentPage, perPage, statusFilter, rangePicker, searchQuery], function () {
    ...
    if (statusFilter.value == 2) {
      ...
      if (tableColumns.length > 8) {
        var keysToRemove = ['debt_price', 'debt_currency'];
        keysToRemove.forEach(function (key) {
          var index = Object.keys(tableColumns).indexOf(key);
          if (index !== -1) {
            Object.keys(tableColumns).splice(index, 1);
