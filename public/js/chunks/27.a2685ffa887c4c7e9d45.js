...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  actions: {
    ...
    //home Reports
    fetchReportsByYearAndMonth: function fetchReportsByYearAndMonth(ctx) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_0__["default"].post("/api/fetchReportsByYearAndMonth").then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
