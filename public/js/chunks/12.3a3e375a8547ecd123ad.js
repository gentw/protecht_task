...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@validations/regex'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props, _ref) {
    ...
    var rules = {
      main_currency: {
        required: _validations__WEBPACK_IMPORTED_MODULE_3__["required"],
        regex: !(function webpackMissingModule() { var e = new Error("Cannot find module '@validations/regex'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(/^(\d+|\d+\.\d{1,2})$/, 'The field must be a valid currency')
      }
    };
