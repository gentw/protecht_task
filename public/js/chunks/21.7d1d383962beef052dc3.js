...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    var rangePicker = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["ref"])(null);
    var currencyOptions = [{
      label: 'Euro',
      value: 'euro'
    }, {
    ...
    var filterSalesByDate = function filterSalesByDate() {
      // if (rangePicker.value && rangePicker.value.length >= 2) {
      //   const startDate = rangePicker.value[0].toISOString().split('T')[0];
      //   const endDate = rangePicker.value[1].toISOString().split('T')[0];
      // }
