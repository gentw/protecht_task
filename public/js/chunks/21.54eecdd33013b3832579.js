            ...
            scopedSlots: _vm._u([
              ...
              },
              {
                ...
                fn: function (data) {
                  return [
                    _c("b-media", { attrs: { "vertical-align": "center" } }, [
                      !Number.isInteger(data.item.company_funds.current_balance)
                        ? _c("span", [
                            _c("span", [
                              _vm._v(
                                "\n             " +
                                  _vm._s(
                                    data.item.company_funds.current_balance
                                  ) +
                                  " Euro\n              "
                              ),
                            ]),
...
function useTransactionsList() {
  ...
  var tableColumns = [{
    ...
    key: 'company_funds.current_balance',
    label: 'Te mbetura'
  }, {
    key: 'type',
    label: 'Lloji i transaksionit',
    sortable: true
  }, {
    key: 'created_at',
    label: 'Data'
  ...
  var dataMeta = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_0__["computed"])(function () {
    var localItemsCount = refTransactionListTable.value ? refTransactionListTable.value.localItems.length : 0;
    return {
  ...
  var fetchTransactions = function fetchTransactions(ctx, callback) {
    _store__WEBPACK_IMPORTED_MODULE_1__["default"].dispatch('app-transaction/fetchTransactions', {
      q: searchQuery.value,
