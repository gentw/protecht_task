...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _home_gex_development_bluesky_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js */ "./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js");
...
/* harmony import */ var _SalesListFilters_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./SalesListFilters.vue */ "./resources/js/src/views/sales/sales-list/SalesListFilters.vue");
/* harmony import */ var _useSalesList__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./useSalesList */ "./resources/js/src/views/sales/sales-list/useSalesList.js");
/* harmony import */ var _saleStoreModule__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../saleStoreModule */ "./resources/js/src/views/sales/saleStoreModule.js");
/* harmony import */ var _views_services_serviceStoreModule__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @/views/services/serviceStoreModule */ "./resources/js/src/views/services/serviceStoreModule.js");
...
/* harmony import */ var _SaleListAddNew_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./SaleListAddNew.vue */ "./resources/js/src/views/sales/sales-list/SaleListAddNew.vue");
/* harmony import */ var _SaleListPayDebt_vue__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./SaleListPayDebt.vue */ "./resources/js/src/views/sales/sales-list/SaleListPayDebt.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    SalesListFilters: _SalesListFilters_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    SaleListAddNew: _SaleListAddNew_vue__WEBPACK_IMPORTED_MODULE_12__["default"],
    SaleListPayDebt: _SaleListPayDebt_vue__WEBPACK_IMPORTED_MODULE_13__["default"],
  ...
  setup: function setup() {
    ...
    // Register module
    if (!_store__WEBPACK_IMPORTED_MODULE_3__["default"].hasModule(SALE_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_3__["default"].registerModule(SALE_APP_STORE_MODULE_NAME, _saleStoreModule__WEBPACK_IMPORTED_MODULE_8__["default"]);
    if (!_store__WEBPACK_IMPORTED_MODULE_3__["default"].hasModule(SERVICE_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_3__["default"].registerModule(SERVICE_APP_STORE_MODULE_NAME, _views_services_serviceStoreModule__WEBPACK_IMPORTED_MODULE_9__["default"]);
    if (!_store__WEBPACK_IMPORTED_MODULE_3__["default"].hasModule(USER_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_3__["default"].registerModule(USER_APP_STORE_MODULE_NAME, _views_user_userStoreModule__WEBPACK_IMPORTED_MODULE_11__["default"]);
    ...
    var isAddNewSaleSidebarActive = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["ref"])(false);
    var isPayDebtSaleActive = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["ref"])(false);
    var userIdToPayDebt = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["ref"])(0);
    var saleIdToPayDebt = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["ref"])(0);
    var invoiceUrl = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["ref"])(null);
    var payDebtInfo = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["ref"])(null);
    var currencyOptions = [{
      label: 'Euro',
      value: 'euro'
    }, {
    ...
    var payDebt = function payDebt(sale_id, client_id) {
      ...
      _store__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch('app-sale/fetchDebtSale', {
        saleId: sale_id,
        clientId: client_id
    ...
    var cancelSale = function cancelSale(saleId, clientId) {
      ...
      _store__WEBPACK_IMPORTED_MODULE_3__["default"].dispatch('app-sale/cancelSale', saleData).then(function () {
        refetchData();
      });
    };
    ...
    var computedTableColumns = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_4__["computed"])(function () {
      var newTableColumns = Object(_home_gex_development_bluesky_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(tableColumns); // Create a new array to avoid modifying the original

      if (statusFilter.value === null) {
        newTableColumns.splice(6, 0, {
          key: 'debt_price',
          sortable: true,
          label: 'Borxhi paguar'
        });
        newTableColumns.splice(7, 0, {
          key: 'debt_price_unpaid',
          sortable: true,
          label: 'Borxhi mbetur'
        });
      } else {
        var removeColumns = ['debt_price', 'debt_price_unpaid'];
        return newTableColumns.filter(function (column) {
          return !removeColumns.includes(column.key);
        });
      }
    ...
    var _useSalesList = Object(_useSalesList__WEBPACK_IMPORTED_MODULE_7__["default"])(),
      ...
      deleteSale = _useSalesList.deleteSale,
    ...
    return {
      ...
      computedTableColumns: computedTableColumns
    };
  }
});
...
function useUsersList() {
  ...
  var refSaleListTable = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_1__["ref"])(null);

  // Table Handlers
  var tableColumns = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_1__["reactive"])({});
  var perPage = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_1__["ref"])(10);
  var totalSales = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_1__["ref"])(0);
  ...
  var rangePicker = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_1__["ref"])(null);
  var salesReportData = Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_1__["ref"])(null);
  ...
  Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_1__["watch"])([currentPage, perPage, statusFilter, rangePicker, searchQuery], function () {
    refetchData();
    if (statusFilter.value == 2 || statusFilter.value === null) {
      ...
      [{
        ...
        key: 'actions'
      }], Object(_home_gex_development_bluesky_node_modules_babel_runtime_helpers_esm_readOnlyError_js__WEBPACK_IMPORTED_MODULE_0__["default"])("tableColumns");
    } else {
      [{
        key: 'client_name',
        sortable: true,
  ...
  var deleteSale = function deleteSale(id) {
    _store__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch('app-sale/deleteSale', id).then(function () {
      refetchData();
    });
  };
  var fetchSales = function fetchSales(ctx, callback) {
    _store__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch('app-sale/fetchSales', {
      q: searchQuery.value,
      ...
      if (statusFilter.value != null && rangePicker.value != null) {
        _store__WEBPACK_IMPORTED_MODULE_2__["default"].dispatch('app-sale/fetchSalesReport', {
          status: statusFilter.value,
          rangePicker: rangePicker.value
        }).then(function (response) {
