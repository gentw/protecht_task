...
/* harmony import */ var _views_sales_saleStoreModule__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/views/sales/saleStoreModule */ "./resources/js/src/views/sales/saleStoreModule.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup() {
    ...
    // Register module
    if (!_store__WEBPACK_IMPORTED_MODULE_5__["default"].hasModule(SALE_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_5__["default"].registerModule(SALE_APP_STORE_MODULE_NAME, _views_sales_saleStoreModule__WEBPACK_IMPORTED_MODULE_4__["default"]);
    if (!_store__WEBPACK_IMPORTED_MODULE_5__["default"].hasModule(USER_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_5__["default"].registerModule(USER_APP_STORE_MODULE_NAME, userStoreModule);
    ...
    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_3__["onUnmounted"])(function () {
      if (_store__WEBPACK_IMPORTED_MODULE_5__["default"].hasModule(SALE_APP_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_5__["default"].unregisterModule(SALE_APP_STORE_MODULE_NAME);
    ...
    var generateReports = function generateReports() {
      _store__WEBPACK_IMPORTED_MODULE_5__["default"].dispatch('app-sale/fetchReportsByYearAndMonth', selectMonthYear).then(function (response) {
  ...
  return _c(
    ...
    [
      _c(
        "b-card",
        [
          _c("b-card-text", [_c("h4", [_vm._v("Shfaq raportet sipas dates")])]),
          _vm._v(" "),
          _c(
            "div",
            [
                        ...
                        [
                          ...
                          _c("b-form-select", {
                            ...
                            model: {
                              ...
                              callback: function ($$v) {
                                _vm.$set(_vm.selectMonthYear, "month", $$v)
                              },
                                  ...
                                  _c(
                                    ...
                                    [
                                      ...
                                      _c("strong", [
                                        _vm._v(
                                          _vm._s(
                                            _vm.data.profit_euro.toFixed(2)
                                          )
                                        ),
                                      ]),
                                    ]
                                ...
                                _c("b-media-body", [
                                  _c(
                                    ...
                                    [
                                      ...
                                      _c("strong", [
                                        _vm._v(
                                          _vm._s(_vm.data.profit_usd.toFixed(2))
                                        ),
                                      ]),
                                    ]
                                  ),
                                ...
                                _c("b-media-body", [
                                  _c(
                                    ...
                                    [
                                      ...
                                      _c("strong", [
                                        _vm._v(
                                          _vm._s(_vm.data.profit_chf.toFixed(2))
                                        ),
                                      ]),
                                    ]
                                  ),
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c(
                          ...
                          [_vm._v("(Bilanci ne euro, shpenzimet e kalkuluara)")]
                        ),
                        _vm._v(" "),
                        _c(
                          "div",
